...
class EditAcademicProgramRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'modular_code' => 'sometimes|string|exists:institutions,modular_code',
            'academic_program_bim' => 'sometimes',
            'academic_program_start' => 'sometimes|date_format:Y-m-d\TH:i',
            'academic_program_finish' => 'sometimes|date_format:Y-m-d\TH:i',
            'id_academic_calendar' => 'sometimes|numeric|exists:academic_calendars,id_academic_calendar'
        ];
    }
