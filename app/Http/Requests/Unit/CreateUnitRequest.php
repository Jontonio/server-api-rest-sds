...
class CreateUnitRequest extends FormRequest
{
    ...
    {
        return [
            'unit_start' => 'required|date_format:Y-m-d\TH:i',
            'unit_finish' => 'required|date_format:Y-m-d\TH:i',
            'unit_name' => 'sometimes|nullable|string|max:20',
            'unit_description' => 'sometimes|nullable|string|max:350',
            'id_academic_program' => 'required|exists:academic_programs,id_academic_program',
        ];
    }
